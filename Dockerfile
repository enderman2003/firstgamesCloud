...
CMD /nakama/nakama --database.address "postgresql://firstgamesAdmin:eK9nIS6Nhqt9c2kgDQ31uQ@free-tier12.aws-ap-south-1.cockroachlabs.cloud:26257/defaultdb?options=--cluster%3Dfirstgames-902" migrate up && /nakama/nakama --config /nakama/data/config.yml
